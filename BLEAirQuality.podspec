#
# Be sure to run `pod lib lint BLEAirQuality.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'BLEAirQuality'
  s.version          = '0.1.0'
  s.summary          = 'A short description of BLEAirQuality.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'BLEAirQuality' => ['BLEAirQuality/Assets/*.png']
  # }
